...
function FrontDiagramSvg({ C, actuals, pinStatuses }: DiagramSvgProps) {
  ...
  return (
    ...
    >
      ...
      <line x1="25" y1="280" x2="1075" y2="280" stroke={C.svgLine} strokeWidth="1.5" markerStart="url(#arrow)" markerEnd="url(#arrow)" />
      <line x1="20" y1="290" x2="20" y2="190" stroke={C.svgLine} strokeWidth="1.5" />
      <line x1="1080" y1="290" x2="1080" y2="190" stroke={C.svgLine} strokeWidth="1.5" />    
      <SvgCard
        x={480}
        y={250}
      ...
      <line x1="90" y1="10" x2="1015" y2="10" stroke={C.svgLine} strokeWidth="1.5" markerStart="url(#arrow)" markerEnd="url(#arrow)" />
      <line x1="85" y1="5" x2="85" y2="100" stroke={C.svgLine} strokeWidth="1.5" />
      <line x1="1020" y1="5" x2="1020" y2="100" stroke={C.svgLine} strokeWidth="1.5" />
      ...
      <circle cx={1025} cy={170} r="5" stroke={C.svgRing} strokeWidth="4" fill="none" /> 
         
      {/* 12.2 mm  */}
     <circle cx={1050} cy={150} r="16" stroke={C.svgRing} strokeWidth="6" fill="none" />
      <line x1="1050" y1="170" x2="1050" y2="210" stroke={C.svgLine} strokeWidth="1.5" markerStart="url(#arrow)" />
      ...
      <SvgCard
        ...
        y={205}
        label="12.2mm"
        high={svgSpecHigh(st1.params[5])}
        low={svgSpecLow(st1.params[5])}
        value={svgActualValue(st1.params[5], st1a[5])}
        C={C}
      />
      ...
      {/* left side 4.98 .. */}
         {/* 4.98 mm  */}
      <line x1="75" y1="175" x2="75" y2="220" stroke={C.svgLine} strokeWidth="1.5" markerStart="url(#arrow)" />

   
      <circle cx={75} cy={167} r="5" stroke={C.svgRing} strokeWidth="3" fill="none" />
      ...
      <SvgCard
        ...
        C={C}
      />
   {/* Left  side hole n o parameter */}
      <circle cx={55} cy={148} r="16" stroke={C.svgRing} strokeWidth="6" fill="none" />
...
{/* 3pin1 3pin2 3pin3 contunously  */}
              ...
              <circle id="ballHoleLeftCircle" cx={37} cy={54} r="6" stroke={C.svgRing} strokeWidth="4" fill="none" />
              
              <line id="ballHoleLeftLine" x1="35" y1="45" x2="120" y2="5" stroke={C.svgLine} strokeWidth="1.5" markerStart="url(#arrow)" />
  <SvgCard id="ballHoleLeft" x={110} y={-15} label="Ball hole" high={svgSpecHigh(st6.params[2])} low={svgSpecLow(st6.params[2])} value={svgActualValue(st6.params[2], st6a[2])} C={C} />
              </g>

{/*left 6
2 mm*/}
              <g id="ballHoleRightGroup" data-station="ST-06" data-table-id="ballHoleRight">
              <SvgCard id="ballHoleRight" x={250} y={32} label="Ball hole" high={svgSpecHigh(st6.params[3])} low={svgSpecLow(st6.params[3])} value={svgActualValue(st6.params[3], st6a[3])} C={C} />

              <line id="ballHoleRightLine" x1="80" y1="58" x2="250" y2="58" stroke={C.svgLine} strokeWidth="1.5" markerStart="url(#arrow)" />
            
              <circle id="ballHoleRightCircle" cx={62} cy={52} r="13" stroke={C.svgRing} strokeWidth="4" fill="none" />
              </g>
              ...
              <g id="plugHoleLeftGroup" data-station="ST-05" data-table-id="plugHoleLeft">
              <circle id="plugHoleLeftCircle" cx={1015} cy={255} r="6" stroke={C.svgRing} strokeWidth="4" fill="none" />
              <line id="plugHoleLeftLine" x1="810" y1="250" x2="1000" y2="250" stroke={C.svgLine} strokeWidth="1.5" markerEnd="url(#arrow)" />
              <SvgCard id="plugHoleLeft" x={700} y={215} label="Plug Hole" high={svgSpecHigh(st5.params[0])} low={svgSpecLow(st5.params[0])} value={svgActualValue(st5.params[0], st5a[0])} C={C} />
              </g>

{/* bottom right 6.2mm */}
              <g id="plugHoleRightGroup" data-station="ST-05" data-table-id="plugHoleRight">
              <circle id="plugHoleRightCircle" cx={1040} cy={255} r="13" stroke={C.svgRing} strokeWidth="4" fill="none" />

              <line id="plugHoleRightLine" x1="1053" y1="265" x2="1053" y2="290" stroke={C.svgLine} strokeWidth="1.5" markerStart="url(#arrow)" />
              <line id="plugHoleRightLeader" x1="950" y1="290" x2="1053" y2="290" stroke={C.svgLine} strokeWidth="1.5" />
              <SvgCard id="plugHoleRight" x={850} y={260} label="Plug Hole" high={svgSpecHigh(st5.params[1])} low={svgSpecLow(st5.params[1])} value={svgActualValue(st5.params[1], st5a[1])} C={C} />
              </g>
